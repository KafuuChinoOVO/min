		...
		<div class="content-wrapper">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号"
							value="${OrdersDetailsVo.orderNum }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								...
								value="${OrdersDetailsVo.orderTimeStr}">
						</div>
					</div>
					<div class="col-md-2 title">路线名称</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="路线名称"
							value="${orders.OrdersDetailsVo.productName }" readonly="readonly">
					</div>

					<div class="col-md-2 title">出发城市</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出发城市"
							value="${orders.OrdersDetailsVo.cityName }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${OrdersDetailsVo.departureTimeStr}"
								readonly="readonly">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							value="${OrdersDetailsVo.peopleCount}" readonly="readonly">
					</div>

					<div class="col-md-2 title rowHeight2x">其他信息</div>
					<div class="col-md-10 data rowHeight2x">
						<textarea class="form-control" rows="3" placeholder="其他信息">
							${OrdersDetailsVo.orderDesc }
						</textarea>
					</div>
			...
			<div class="panel panel-default">
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="traveller" items="${OrdersDetailsVo.travellers}">
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${OrdersDetailsVo.nickname }</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${OrdersDetailsVo.name}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${OrdersDetailsVo.PHONENUM}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${OrdersDetailsVo.email}</div>

				</div>
			</div>
			<!--联系人信息/--> <!--费用信息--> <c:if test="${OrdersDetailsVo.orderStatus==1}">
				<div class="panel panel-default">
					<div class="panel-heading">费用信息</div>
					<div class="row data-type">

						<div class="col-md-2 title">支付方式</div>
						<div class="col-md-4 data text">在线支付-${OrdersDetailsVo.payTypeStr}</div>
						OrdersDetailsVo
						<div class="col-md-2 title">金额</div>
						<div class="col-md-4 data text">￥${OrdersDetailsVo.productPrice}</div>
