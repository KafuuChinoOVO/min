...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/product/findById.do"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type" >
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%"
                                    name="productStatus" >
                                <option value="0" <c:if test="${product.productStatusStr == '关闭'}"> selected="selected"</c:if>>关闭</option>
                                <option value="1" <c:if test="${product.productStatusStr == '开启' }"> selected="selected"</c:if>>开启</option>
                            </select>
                        </div>
